...
// get the data
d3.csv("noncustomers_supplier.csv").then(function (data) {

    let filtered_data = data.filter(function (d) { return d.brand == "BrandA" })
    ...
    bars.append("rect")
        ...
        .attr("fill", function (d) {
            if (d.metric.includes('Unaware')) { return "grey" }
            else { return "#1072BD" }
            ;
        })
